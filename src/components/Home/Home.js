...
const MAP = {
  name: "my-map",
  areas: [
    { name: "1", shape: "rect", coords: [10,243,255,108], preFillColor: "white"  },
    { name: "2", shape: "rect", coords: [271,24,772,203], preFillColor: "white"  },
    { name: "3", shape: "rect", coords: [792,38,1295,152], preFillColor: "white"  },
    { name: "4", shape: "rect", coords: [1304,7,1750,146], preFillColor: "white"  },
  ]
};
